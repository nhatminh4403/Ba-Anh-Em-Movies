...
public class FilmService {
    ...
    // existingFilm.setName(film.getName() != null ? film.getName() :
    // existingFilm.getName());
    // existingFilm.setTrailer(film.getTrailer() != null ? film.getTrailer() :
    // existingFilm.getTrailer());
    // existingFilm.setDescription(film.getDescription() != null ?
    // film.getDescription() : existingFilm.getDescription());
    // existingFilm.setPoster(film.getPoster() != null ? film.getPoster() :
    // existingFilm.getPoster());
    // existingFilm.setDirector(film.getDirector() != null ? film.getDirector() :
    // existingFilm.getDirector());
    // existingFilm.setActor(film.getActor() != null ? film.getActor() :
    // existingFilm.getActor());
    // existingFilm.setOpeningday(film.getOpeningday() != null ?
    // film.getOpeningday() : existingFilm.getOpeningday());
    // existingFilm.setSubtitle(film.getSubtitle() != null ? film.getSubtitle() :
    // existingFilm.getSubtitle());
    // existingFilm.setDuration(film.getDuration() != 0 ? film.getDuration() :
    // existingFilm.getDuration());
    // existingFilm.setLimit_age(film.getLimit_age() != null ? film.getLimit_age() :
    // existingFilm.getLimit_age());
    // existingFilm.setCountry(film.getCountry() != null ? film.getCountry() :
    // existingFilm.getCountry());
    // existingFilm.setCategory(film.getCategory() != null ? film.getCategory() :
    // existingFilm.getCategory());
    //
    // return filmRepository.save(existingFilm);
    // } else {
    // throw new IllegalArgumentException("Film with ID " + film.getId() + " does
    // not exist");
    // }
